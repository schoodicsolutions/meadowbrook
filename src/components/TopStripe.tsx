...
export default function TopStripe() {
    ...
    return (
        <div className="flex w-full 2xl:absolute 2xl:top-0 2xl:right-0 2xl:w-fit text-base sm:text-lg font-headings font-semibold justify-around">
            <div className="border-transparent border-b-scarlet border-r-scarlet 2xl:border-[22px] w-0 h-0" />
            <div className="bg-scarlet h-[44px] px-2 sm:px-6 2xl:px-[44px] flex gap-12 text-white font-bold items-center grow">
                <div className="flex m-auto gap-4 sm:gap-11 2xl:gap-24 2xl:pr-40">
