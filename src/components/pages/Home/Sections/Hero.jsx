...
function Hero() {
    ...
    return (
        <>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ transition: 0.1 }} className='px-4 md:px-12 h-[56vh] sm:h-[52vh] lg:h-[72vh] flex items-center justify-start' style={
                {
                ...
                <div className='w-full max-w-[95rem] m-auto text-white'>
                    ...
                    <div className='overflow-hidden mb-4'>
                        <p className='text-lg w-full max-w-xl mb-4'>
